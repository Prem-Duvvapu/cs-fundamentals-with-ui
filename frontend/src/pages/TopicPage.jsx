...
export default function TopicPage() {
  ...
  const titleMap = {
    ...
    'spring-data-jpa-repositories': 'Spring Data JPA Repositories & Query Derivation',
    ...
    'event-driven-messaging': 'Event-Driven Messaging: Kafka, RabbitMQ & the Outbox Pattern',
    'microservices-patterns': 'Microservices Patterns: Discovery, Circuit Breakers & Config',
