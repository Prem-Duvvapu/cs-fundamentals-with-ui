...
#### Q1: How does `@ControllerAdvice` and `@ExceptionHandler` handle exceptions inside Spring MVC?
...
#### Q2: What is the performance benefit of `AsyncHandlerInterceptor` and `DeferredResult` in Spring MVC?
